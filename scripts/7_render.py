...
<p class="caption">
  <b>关于点名：</b>页面上只写出<b>已经被 GitHub 删除</b>的仓库名。检测器精度约 99%，
  一万八千个里注定有一两百个是误判，而这个页面的维护者没法向被误判的活着的项目解释什么，
...
GitHub 自己把它们删掉了。</p>
<p><b>口径与边界。</b>检测器精度约 99%，一万八千多个仓库里预计有一两百个误判，
所以本页只写出已被删除的仓库名。「假星」始终指
